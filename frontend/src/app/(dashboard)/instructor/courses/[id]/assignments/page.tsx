  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <div className="text-sm text-muted-foreground mb-1">Kursi: {courseTitle}</div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-foreground">{totalStats.totalAssignments}</p>
                <p className="text-sm text-muted-foreground">Detyra totale</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-foreground">{totalStats.totalSubmissions}</p>
                <p className="text-sm text-muted-foreground">Dergesa totale</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-foreground">{totalStats.totalGraded}</p>
                <p className="text-sm text-muted-foreground">Te vleresuara</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-foreground">{totalStats.totalUngraded}</p>
                <p className="text-sm text-muted-foreground">Per vleresim</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <h3 className="font-medium text-foreground mb-2">Asnje detyre</h3>
              <p className="text-muted-foreground">Ky kurs nuk ka detyra te krijuara.</p>
            </div>
          </CardContent>
        </Card>
      ) : (
                  ...
                  <TableRow key={assignment.id} className="cursor-pointer hover:bg-muted/50">
                    <TableCell>
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{assignment.lessonTitle}</p>
                      </div>
                    </TableCell>
                    <TableCell>
